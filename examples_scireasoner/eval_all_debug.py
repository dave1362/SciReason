...
with read_base():
    ...
    from opencompass.configs.datasets.LLM4Chem.retrosynthesis import Retrosynthesis_datasets as Retrosynthesis_uspto50k_datasets
    ...
    from opencompass.configs.datasets.Mol_Instructions.molecule import mol_mol_datasets
    ...
    from opencompass.configs.datasets.unconditional_protein_generation.UPG import UPG_datasets  as uncond_protein_datasets
    # unconditional molecule generation task
    from opencompass.configs.datasets.unconditional_molecule_generation.UMG import UMG_Datasets

    from opencompass.configs.models.scireason.hf_dubug import models
